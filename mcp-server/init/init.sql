...
INSERT OR IGNORE INTO echo_profile (id, doc) VALUES ('root', '{"schems":{"identity":"이름/역할 등 기본 신원 정보","tone":"말투 기본 톤 — 존댓말/반말 기준, 버블 분할, 오타 패턴, 어미, 물음표/느낌표 사용 등","emoji":"이모지·이모티콘(그래픽/텍스트) 사용 빈도와 맥락","signoffs":"대화 마무리 인사/종료 패턴","notes":"샘플 출처 및 프로파일 메타 노트","register":"채널·상대별 톤 레지스터 (축: 채널:상대)","situational":"상황별 정형 반응 패턴 (축: 상황명)","writing_genre":"글쓰기 문체 — 장르별(수필/블로그/개발문서 등) 톤·구조 (축: 장르명)","editorial":"글쓰기 시 참고할 타인/외부 문체 레퍼런스 라이브러리 (축: 레퍼런스명). writing_genre(사용자 본인 문체)와 달리 명시적으로 호출했을 때만 사용한다.","lexicon":"자주 쓰는 구체적 표현/캐치프레이즈 저장고 (축: 표현 자체). tone의 카테고리별 압축 요약과 달리, 개별 단어/문구를 하나씩 독립적으로 담아둔다."},"isOnboard":false,"onboarded_at":null,"created_at":"1970-01-01T00:00:00.000Z","modified_at":"1970-01-01T00:00:00.000Z"}');
